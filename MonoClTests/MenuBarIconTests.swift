...
struct MenuBarIconTests {
    ...
    func accessibilityDescriptionCarriesMagnitudes() {
        let icon = image(
            session: .critical, sessionPercent: 94,
    ...
    private func alpha(
        _ rep: NSBitmapImageRep, atPercent percent: Double,
        radius: Double
    ) throws -> Double {
    ...
    private func faintestAlpha(
        _ rep: NSBitmapImageRep, aroundPercent percent: Double,
        radius: Double
    ) throws -> Double {
    ...
    func sessionSweepsClockwiseOnTheRing() throws {
        let rep = try bitmap(
            of: image(
                session: .nominal, sessionPercent: 30,
    ...
    private func redraw(
        _ icon: NSImage, under named: NSAppearance.Name,
        atPercent percent: Double, radius: Double
    ) throws -> NSColor {
